    ...
    <>
        ...
        <div className="bg-[#F7F7FB] rounded-[20px] px-[10px] sm:px-[14px] md:px-[20px] py-[14px] md:py-[20px] space-y-4 border-3 border-[#dcdcdc] border-dashed">
          ...
          <div className="flex flex-wrap gap-[16px] md:gap-[20px] ">
            {suggestions.map((activity, idx) => (
              <div
                key={activity.id + idx}
                className="items-center flex flex-col sm:flex-row justify-between w-full sm:w-[45%] gap-[12px] md:gap-[20px] bg-white border border-[#DCDCDC] rounded-[20px] p-[12px] md:p-[20px]"
              >
                {/* Resume Image */}
                <img
                  alt="resume"
      ...
      {modalOpen && selected && (
       <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#7a7a7a] bg-opacity-40">
        ...
        <div className="bg-white rounded-2xl p-6 w-[80%] h-[80%] shadow-lg relative">
...
>
  ...
  <h2 className="text-4xl font-bold">{selected.title || selected.type}</h2>
  ...
  <h3 style={{ margin: 0, fontSize: '2xl' }}>Suggestions</h3>
  <ul className="list-disc list-inside text-left text-gray-800 text-lg">
