...
// import ProgressIndicator_dashboard from "../commonComponents/ProgressIndicator_dashboard";
import ProgressIndicator_dashboard from "../commonComponents/ProgressIndicator-dashboard";
...
const MyResumes = () => {
  ...
  return (
    <>
      ...
      {/* Recent Activity */}
      <div className={`box-border p-5  border ${darkMode?'border-[#A000FF]':'border-[#A000FF]'} ${darkMode?'bg-[#9810FA0D]':'bg-[#9810FA0D]'}   rounded-[20px] mt-[2vw] `}>
            ...
            >
              ...
              <div className="flex flex-col gap-3 sm:gap-4 md:gap-5 w-full md:w-auto">
                ...
                <div className="flex flex-col md:flex-row items-center justify-evenly box-border">
                  {/* ATS Progress Card */}
                <div className={`w-full lg:w-[45%] px-2 py-3 sm:px-4 sm:py-4 md:px-2 md:py-5 ${darkMode?'bg-[#1A1D23]':'bg-[white]'} border  ${darkMode?'border-[#363B45]':'border-[#DCDCDC]'} text-xl sm:text-2xl font-manrope font-bold flex items-center justify-center gap-5 rounded-2xl shadow-sm`}>
  <p className={`${darkMode?'text-[white]':'text-[#1E1B39]'}`} >ATS</p>
  <ProgressIndicator_dashboard percentage={10} />
</div>
                  {/* download */}
                  <div className={`w-full lg:w-[45%] px-2 py-3 sm:px-4 sm:py-4 md:px-2 md:py-5 ${darkMode?'bg-[#1A1D23]':'bg-[#E3F6FF]'}  border ${darkMode?'border-[#363B45]':'border-[#74D4FF]'}   flex flex-col md:flex-col justify-between rounded-2xl gap-2 sm:gap-4 md:gap-4 shadow-sm`}>
