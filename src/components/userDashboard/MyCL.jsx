...
const MyResumes = () => {
  ...
  return (
    <>
      ...
      <div className="box-border p-5 border-3 border-dashed border-[#00A6F4] rounded-[20px] mt-[2vw] bg-[#f6fcff]">
        ...
        {recentActivities.map((activity) => (
          <React.Fragment key={activity.id}>
            ...
            >
              ...
              <div className="flex flex-col gap-3 sm:gap-4 md:gap-5 w-full md:w-auto">
                ...
                <div className="flex items-center justify-evenly box-border">
                  {/* download */}
                  <div className="w-[100%] px-2 py-3 sm:px-4 sm:py-4 md:px-2 md:py-5 bg-white border border-[#DCDCDC] flex flex-col md:flex-col justify-between rounded-2xl gap-2 sm:gap-4 md:gap-4 shadow-sm">
            ...
            <div style={{ width: "100%", border: '1px solid #00A6F4', height: '0', margin: '1vw 0' }}></div>
          </React.Fragment>
        ))}
      </div>
      {/* <Alltools/> */}
