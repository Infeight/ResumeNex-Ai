...
const DashboardContent = () => {
  ...
  return (
    <section className="flex flex-col gap-[40px]">
     ...
     <p
  className="
    flex gap-1 font-lexend font-semibold text-[28px] sm:text-[36px] md:text-[40px] text-[#1E1B39]
    bg-white z-10
...
/>
      ...
      {/* Recent Activity  */}
      <div className="w-full space-y-[18px] sm:space-y-[20px] md:space-y-[25px] border border-[#B8E6FE] bg-[#F0F9FF] px-[8px] sm:px-[14px] md:px-[20px] py-[16px] sm:py-[22px] md:py-[27px] rounded-[18px] md:rounded-[25px]">
        <p className="font-lexend font-semibold text-[18px] sm:text-[22px] md:text-[25px] text-[#1E1B39]">
          Recent Activity
        </p>
...
<div className="mt-2 font-lexend text-xs sm:text-base md:text-lg border border-[#D3D9DE] text-white px-3 sm:px-4 py-1 sm:py-2 rounded-xl flex items-center justify-center gap-2 cursor-pointer bg-gradient-to-t from-[#336EE7] to-[#4C95FB]">
  ...
  <div className="max-w-[calc(50%-0.25rem)] sm:w-full font-lexend font-semibold text-[10px] sm:text-base md:text-lg border-2 px-1.5 sm:px-5 py-1 sm:py-2 rounded-xl flex items-center justify-center gap-1.5 sm:gap-3 cursor-pointer text-[#00A63E] border-[#00A63E] bg-[#F2FBF5]">
    ...
    Whatsapp
      ...
      {/* refer */}
      <div className="px-[10px] sm:px-[18px] md:px-[30px] py-[10px] sm:py-[14px] md:py-[20px] bg-[#F7F7FB] space-y-[10px] sm:space-y-[14px] md:space-y-[20px] rounded-[14px] sm:rounded-[18px] md:rounded-[20px] w-full sm:w-fit mx-auto">
      <p className="font-lexend font-semibold text-[22px] sm:text-[28px] md:text-[40px] text-[#1E1B39] text-center sm:text-left">
