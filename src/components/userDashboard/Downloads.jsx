...
/>
      ...
      <div style={{display:activity.type=='Resume'?'flex':'none'}} className="flex flex-col items-start"  
       ...
       className="flex justify-center gap-[10px] border border-[#6EE7B7] w-full py-[5px] rounded-full bg-[#ECFDF5] text-[#059669] font-inter font-semibold text-[16px] md:text-[19.2px] cursor-pointer transition-all hover:scale-95 mt-2 sm:mt-0"
      >
       Check ATS Score
     </label>
     </div>
