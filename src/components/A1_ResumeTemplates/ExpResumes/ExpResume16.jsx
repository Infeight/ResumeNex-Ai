    ...
    <div className="font-['Roboto',sans-serif] m-0 p-0 bg-white text-[#333] w-[794px] mx-auto my-[20px] p-[12mm_15mm] text-[11pt] leading-[1.4] relative">
      ...
      <div className="flex justify-between mb-[12px]">
        ...
        <div className="w-[30%] text-[9.5pt] leading-[1.4] text-right pt-[8px]">
          ...
          <br />
          raymond.ortiz@email.com
          <br />
          (123) 456-7890
          <br />
          <a
            href="https://linkedin.com/in/raymondortiz"
            className="text-[#333] no-underline hover:underline"
          >
            linkedin.com/in/raymondortiz
          </a>
          <br />
          <a
            href="https://github.com/raymondortiz"
            className="text-[#333] no-underline hover:underline"
          >
            github.com/raymondortiz
          </a>
          <br />
          <a
            href="https://raymondortiz.dev"
            className="text-[#333] no-underline hover:underline"
          >
            raymondortiz.dev
          </a>
          <br />
          <a
            href="https://figma.com/@raymondortiz"
            className="text-[#333] no-underline hover:underline"
          >
            figma.com/@raymondortiz
          </a>
          <br />
          <a
            href="https://leetcode.com/raymondortiz"
            className="text-[#333] no-underline hover:underline"
          >
            leetcode.com/raymondortiz
          </a>
        </div>
      </div>
      ...
      <div className="text-[10.5pt] mb-[16px] leading-[1.4]">
        ...
        React, and Node.js, with a focus on delivering user-centric solutions.
        Successfully led a project that reduced app load times by 35%, enhancing
        user satisfaction. Skilled in collaborating with cross-functional teams
      ...
      <div className="text-[10pt] mt-[4px] mb-[12px]">
        ...
        <br />
        <span className="font-normal italic">Amazon Web Services</span> | Nov
        2022
        <br />
        <a
      ...
      <ul className="mt-[4px] mb-[12px] pl-[18px] text-[10pt] space-y-[3px]">
        <li>
          <span className="font-medium">Employee of the Year</span> - TechTrend
          Solutions, 2022
        </li>
        <li>
          <span className="font-medium">Hackathon Runner-Up</span> - Dallas
          TechFest, 2021
        </li>
      </ul>
    </div>
