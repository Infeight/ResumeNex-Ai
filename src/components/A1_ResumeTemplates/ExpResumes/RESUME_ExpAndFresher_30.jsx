      ...
      <header className="text-center mb-[20px]">
        ...
        <p className="text-[11pt]">
          ...
          >
           ...
           ○{" "}
          <a
            href={formData.figma ? formData.figma : "https://github.com/jarupulavinayak"}
            className="text-[#0000FF] no-underline hover:underline"
          >
            {formData.figma
              ? formData.figma.replace(/^https?:\/\//, "")
              : "figma.com/jarupulavinayak"}
          </a>
           ○{" "}
          <a
            href={formData.otherLink ? formData.otherLink : "https://github.com/jarupulavinayak"}
            className="text-[#0000FF] no-underline hover:underline"
          >
            {formData.otherLink
              ? formData.otherLink.replace(/^https?:\/\//, "")
              : "other.com/jarupulavinayak"}
          </a>
        </p>
      </header>
