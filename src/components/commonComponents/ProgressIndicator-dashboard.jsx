...
const ProgressIndicator_dashboard = ({ percentage }) => {
  ...
  return (
    <div className={`flex items-center justify-center  ${darkMode?'bg-[#1A1D23]':'bg-[white]'} `}>
...
export default ProgressIndicator_dashboard;
