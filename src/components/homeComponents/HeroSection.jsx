  ...
  return (
    <header className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 flex flex-col gap-8 sm:gap-10 md:gap-12">
      ...
      <Link to={"/templates"} className="mx-auto">
        ...
        <button class="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all  bg-gradient-to-t from-[#336EE7] to-[#4C95FB]  rounded-xl group cursor-pointer">
          ...
          <span class="absolute bottom-0 left-0 w-full h-full transition-all duration-500 ease-in-out delay-200 -translate-x-full translate-y-full  bg-gradient-to-t from-blue-600 to-blue-400  rounded group-hover:mb-[58px] group-hover:translate-x-0"></span>
